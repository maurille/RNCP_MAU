package com.maurille.blogmanager.dao;
...
import com.maurille.blogmanager.util.QueryBuilder;
import com.maurille.blogmanager.util.QueryBuilder.TypeWhere;
		...
		try {
			...
			for (String fieldName : this.champs.keySet()) {
				...
				if (fi.typeChamp.equals(int.class)) {
					...
					fi.setter.invoke(entite,
							new Date(rs.getDate(fieldName).getTime()));
				}
			}
